<%@ page language="java" import="java.util.*,com.bean.*,com.servlet.*,java.text.SimpleDateFormat" pageEncoding="UTF-8"%>
<%
...
<%=sf.format(new Date()) %>&nbsp;<a href="<%=basePath%>" style="color: red;">退出</a>
</span></td>
          </tr>
        </table></td>
      </tr>
