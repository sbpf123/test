	  ...
	  <tr>
	    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
	        ...
	        <td width="1101" background="images/tab_05.gif"><img src="images/311.gif" width="16" height="16" /> <span class="STYLE4">已购买书籍</span></td>
	      ...
	      <tr>
	        ...
	        <td bgcolor="#f3ffe3"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#c0de98" onmouseover="changeto()"  onmouseout="changeback()">
	          <tr>
	            ...
	            <td width="8%" height="18" background="images/tab_14.gif" class="STYLE1"><div align="center" class="STYLE2 STYLE1">单价</div></td>
	            <td width="8%" height="18" background="images/tab_14.gif" class="STYLE1"><div align="center" class="STYLE2 STYLE1">出版年份</div></td>
	            <td width="8%" height="18" background="images/tab_14.gif" class="STYLE1"><div align="center" class="STYLE2 STYLE1">购买数量</div></td>
	            ...
	            <td width="8%" height="18" background="images/tab_14.gif" class="STYLE1"><div align="center" class="STYLE2 STYLE1">地址</div></td>
	          </tr>
	        <%
	        if(listcart.size()>0){
	        	int u=0;
	        	for(int i=0;i<listcart.size();i++){
					if(listcart.get(i).getUserid()==user.getId() && listcart.get(i).getState()==1){
							...
							if(listcart.get(i).getBookid()==listbook.get(j).getId()){
								...
								%>
									<tr>
							            ...
							            <td height="18" bgcolor="#FFFFFF" class="STYLE2"><div align="center" class="STYLE2 STYLE1"><%=df.format(Double.valueOf(listcart.get(i).getNumber()) *Double.valueOf(listbook.get(j).getPrices())) %></div></td>
							            <%
